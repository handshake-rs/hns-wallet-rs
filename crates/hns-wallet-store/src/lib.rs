...
impl EntityKind {
    pub const fn label(self) -> &'static str {
        match self {
            ...
            Self::HnsLightWallet => "hns_light_wallet",
...
impl WalletStore {
    ...
    entity_crud_methods!(
        ...
        (
            save_hns_light_wallet,
            hns_light_wallet,
            hns_light_wallet_records,
            delete_hns_light_wallet,
            HnsLightWallet
        ),
        (
            save_known_name,
...
const fn workflow_kind(kind: WorkflowKind) -> &'static str {
    match kind {
        ...
        WorkflowKind::NameUpdate => "name_update",
...
fn parse_workflow_kind(value: &str) -> Result<WorkflowKind, StoreError> {
    match value {
        ...
        "name_update" => Ok(WorkflowKind::NameUpdate),
