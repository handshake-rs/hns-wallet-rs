...
| --- | --- | --- |
| Standalone workspace | 14 crates, resolver 3, Rust 1.89, independent lockfile, no sibling paths; exact `2229be8` CI, CodeQL, and normalized 14-crate preflight passed; all 17 exact-`b24b66c` `hns-rs` 0.2.0 prerequisite archives were published and provenance-verified on 2026-08-14 | authorized wallet publication, tag, and registry verification |
...
All 17 required `hns-rs` 0.2.0 archives were present on crates.io and verified
on 2026-08-14 to identify exact source
`b24b66c382de53330ec21dd3137e056a2bea3e2d`. This resolves the protocol
publication-order prerequisite only. Execute mode revalidates every archive;
wallet authorization, qualification, and all runtime gates remain unchanged.
