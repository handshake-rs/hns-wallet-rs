...
| Denuo market | pinned canonical name-market envelopes; bounded replay/tombstone-safe encrypted fixed-price board with sequence watermarks and CAS restart validation; bounded encrypted/CAS offline V2 offer/cancellation outbox with exact-envelope, request/content-identity, retry, terminal acknowledgement, and restart validation; chain-neutral reservations/sessions | live relay/outbox supervision and acknowledgement authority, peer policy, reporter governance, product integration and qualification |
